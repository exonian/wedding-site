...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WeddingUser.plus_one'
        db.add_column(u'users_weddinguser', 'plus_one',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WeddingUser.plus_one'
        db.delete_column(u'users_weddinguser', 'plus_one')

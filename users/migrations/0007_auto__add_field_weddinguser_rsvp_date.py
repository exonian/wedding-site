...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WeddingUser.rsvp_date'
        db.add_column(u'users_weddinguser', 'rsvp_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WeddingUser.rsvp_date'
        db.delete_column(u'users_weddinguser', 'rsvp_date')

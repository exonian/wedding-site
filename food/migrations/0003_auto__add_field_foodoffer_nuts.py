...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FoodOffer.nuts'
        db.add_column(u'food_foodoffer', 'nuts',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FoodOffer.nuts'
        db.delete_column(u'food_foodoffer', 'nuts')
    ...
    models = {
        ...
        u'food.foodoffer': {
            ...
            'nuts': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'portions': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'reply_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),

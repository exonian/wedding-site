...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FoodOffer.reply_date'
        db.add_column(u'food_foodoffer', 'reply_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FoodOffer.reply_date'
        db.delete_column(u'food_foodoffer', 'reply_date')
